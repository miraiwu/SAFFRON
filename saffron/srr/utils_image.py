...
def augment_volume(img, mode=0):
    '''Kai Zhang (github: https://github.com/cszn)
    '''
    if mode == 0:
        return img
    elif mode == 1:
        return img.rot90(1, [-2, -1]).flip([-2])
    elif mode == 2:
        return img.flip([-2])
    elif mode == 3:
        return img.rot90(3, [-2, -1])
    elif mode == 4:
        return img.rot90(2, [-2, -1]).flip([-2])
    elif mode == 5:
        return img.rot90(1, [-2, -1])
    elif mode == 6:
        return img.rot90(2, [-2, -1])
    elif mode == 7:
        return img.rot90(3, [-2, -1]).flip([-2])
...
def calculate_psnr(img1, img2, border=0):
    # print("imgE min :{}, max:{}, mean{}".format(np.min(img1),np.max(img1),np.mean(img1)))
    # print("imgL min :{}, max:{}, mean{}".format(np.min(img2),np.max(img2),np.mean(img2)))
